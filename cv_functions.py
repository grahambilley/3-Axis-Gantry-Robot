...
def find_carts(img):
    ...
    # Order the dispensing locations
    ...
    d = d[np.lexsort((d[:,0],d[:,2]))]  # Sort along row within each group
    ...
    for idx, i in enumerate(circles[0,:]):
        ...
        cv2.circle(cimg,center=(d[idx,0],d[idx,1]),radius=1,color=(255,0,255),thickness=10)
